...
export function buildHiveSpawnPrompt(input: HiveSpawnPromptInput): string {
	...
	const parts: string[] = [
		...
		"3. Use `brain_write` to record durable findings, blockers, decisions, or handoff notes other agents should know.",
		...
		"- `brain_write`: persist findings for the rest of the hive.",
